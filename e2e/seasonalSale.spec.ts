...
//   Labor Day 2026:    2026-08-19 00:00:00 → 2026-09-07 23:59:59
//
...
const BEFORE_SALE = '2026-08-18T23:59:00-05:00' // Tue Aug 18 23:59 Chicago
const SALE_START = '2026-08-19T00:00:00-05:00'  // Wed Aug 19 00:00 Chicago (first instant)
...
test.describe('Labor Day 2026 sale', () => {
  test(`BEFORE sale window (Aug 18 11:59pm Chicago): no ${SALE_CHIP} chip`, async ({ page }) => {
  ...
  test(`AT sale start (Aug 19 00:00 Chicago): ${SALE_CHIP} chip appears`, async ({ page }) => {
