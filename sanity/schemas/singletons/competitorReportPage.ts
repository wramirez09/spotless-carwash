...
export default defineType({
  name: 'competitorReportPage',
  title: 'Competitor Report page',
  type: 'document',
  preview: { prepare: () => ({ title: 'Competitor Report page' }) },
  groups: [
  ...
  fields: [
    ...
    defineField({ name: 'positionLine', type: 'string', group: 'header' }),
